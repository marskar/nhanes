...
Context: Large epidemiologic cohort studies, such as the National Health and Nutrition Examination Survey (NHANES), collect high-dimensional data that allow for examination of multiple exposures in relation to a given outcome.
...
Design, Setting and Participants: NHANES III collected data on 33,994 participants aged 2 months and older from 1988 to 1994 the United States. The data include Interview, Medical Examination, and Laboratory components and were collected and linked with Mortality data from NDI death certificate records by the National Center for Health Statistics (NCHS) of the Centers for Disease Control and Prevention (CDC).
